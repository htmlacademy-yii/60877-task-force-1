...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 20 2021 г., 23:32
...
(3, 'zboulding2@macromedi', 'Миронов Алексей', 'VJyMV1Zat', '2019-07-25', 3, 3, 3, 'Как принято считать, акционеры крупнейших компаний формируют глобальную экономическую сеть и при этом - рассмотрены исключительно в разрезе маркетинговых и финансовых предпосылок. Я люблю Иру\r\n\r\n', '2021-09-06 00:00:00', 'Оператор ПК', './img/user-man.jpg'),
