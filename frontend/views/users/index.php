...
/**
 * @var \frontend\models\Users[] $users
 */
                ...
                <div class="content-view__feedback-card user__search-wrapper">
                    <div class="feedback-card__top">
                        <div class="user__search-icon">
                            ...
                            <span><?= count($item->activeTasks) ?> заданий</span>
                            <span><?= count($item->activeReplies) ?> отзывов</span>
                        </div>
                        <div class="feedback-card__top--name user__search-card">
                            ...
                            <?php $i = 0;
                            while ($i < $item->user_stars): ?>

                                <span></span>

                                <?php $i++; endwhile; ?>

                            <?php $numberDisabled = 5 - $item->user_stars;
                            $b = 0;
                            while ($b < $numberDisabled): ?>
                                <span class="star-disabled"></span>
                                <?php $b++; endwhile; ?>


                            <b><?= $item->user_rating; ?></b>
                            <p class="user__search-content">
                                <?= $item->user_search_content; ?>

                            </p>
                        </div>
                        <span class="new-task__time">Был на сайте  <?= $item->wasOnSite() ?>  назад</span>
                    </div>
                    <div class="link-specialization user__search-link--bottom">

                        <?php foreach ($item->getTagsArray() as $tagsItem): ?>
                            <a href="#" class="link-regular"><?= $tagsItem ?></a>
                        <?php endforeach; ?>
