...
/**
 * @var \frontend\models\Tasks[] $tasks
 */
            ...
            <div class="new-task__wrapper">
                ...
                <?php foreach ($tasks as $item): ?>
                    <div class="new-task__card">
                        ...
                        <b class="new-task__price new-task__price--translation"><?php echo $item->budget; ?><b>
                                ₽</b></b>
                        <p class="new-task__place"><?php echo $item->task_address; ?></p>


                        <span class="new-task__time"><?php


                            echo $item->getWasOnSite();
