                ...
                <div class="new-task__wrapper">
                    ...
                    <div class="new-task__card">
                        <div class="new-task__title">
                            <a href="#" class="link-regular"><h2><?php echo $item->name; ?></h2></a>
                            <a  class="new-task__type link-regular" href="#"><p><?php echo $item->address; ?></p></a>
                        </div>
                        <div class="new-task__icon new-task__icon--translation"></div>
                        <p class="new-task_description">
                        <?php echo $item->deskription; ?>
                        </p>
                        <b class="new-task__price new-task__price--translation"><?php echo $item->budget; ?><b> ₽</b></b>
                        <p class="new-task__place"><?php echo $item->task_address; ?></p>

<?php 

   $timeToPass = strtotime('now')-strtotime($item->start_date);
$hoursAgo = $timeToPass / 3600;

?>


                        <span class="new-task__time"><?php echo $hoursAgo; ?> часов назад</span>
                    </div>
                    <?php endforeach; ?>
